...
namespace Rookie.Ecom.Business.Interfaces
{
    public interface IProductPictureService
    {
        ...
        */
        Task<List<ProductPictureDto>> GetByIdProductAsync(Guid id);

/*        Task<ProductPictureDto> GetByNameAsync(string name);
*/
        Task<ProductPictureDto> AddAsync(ProductPictureDto categoryDto);

        Task DeleteAsync(Guid id);

        Task UpdateAsync(ProductPictureDto categoryDto);
    }
}