...
{
    public partial class Add_ProductDetail_Order_OrderItem_Rating_Role_User_UserDetail_UserDetail_Address_CityUpdate_ProductPicture_Product_Category : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDetail", x => new { x.CategoryID, x.ProductID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rating", x => new { x.OrderID, x.ProductID, x.UserID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingOrderID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RatingProductID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.RatingOrderID, x.RatingProductID, x.RatingUserID },
